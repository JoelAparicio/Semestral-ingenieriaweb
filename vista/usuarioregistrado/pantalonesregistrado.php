<?php
session_start();
require_once '../../config/base_de_datos.php'; // Asegúrate de que la ruta sea correcta
...
$query = "SELECT * FROM productos WHERE ID_Categoria = (SELECT ID_Categoria FROM categorias WHERE Nombre = 'Pantalones')";
...
<head>
    ...
    <title>Pantalones - GlamGrid</title>
</head>
<body>
